...
const PersonDetails: React.FC<PersonDetailsProps> = ({ person }) => {
  return (
    <Card style={{ flex: 3 }}>
      ...
      <p>
        <b>Birth Year</b>:{" "}
        <p data-testid="person-birth_year">{person.birth_year}</p>
      </p>
      <p>
        <b>Eye Color</b>:{" "}
        <p data-testid="person-eye_color">{person.eye_color}</p>
      </p>
      <p>
      ...
      <p>
        <b>Hair Color</b>:{" "}
        <p data-testid="person-hair_color">{person.hair_color}</p>
      </p>
      <p>
      ...
      <p>
        <b>Skin Color</b>:{" "}
        <p data-testid="person-skin_color">{person.skin_color}</p>
      </p>
      <p>
        <b>Homeworld</b>:{" "}
        <p data-testid="person-homeworld">{person.homeworld}</p>
      </p>
    </Card>
  );
};
