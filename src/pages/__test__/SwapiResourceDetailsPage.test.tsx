...
const MockSwapiResourceDetailsPage: React.FC<SwapiResourceDetailsPageProps> = ({
  resourceType,
}) => {
  return (
    <BrowserRouter>
...
describe("test the SwapiResourcePage component", () => {
  ...
  test("should render name label on people details", () => {
    render(
      <MockSwapiResourceDetailsPage resourceType={ResourceTypes.people} />
    );
  ...
  test("should render name label on planet details", () => {
    render(
      <MockSwapiResourceDetailsPage resourceType={ResourceTypes.planets} />
    );
    const nameElement = screen.getByText(/name/i);
    expect(nameElement).toBeInTheDocument();
  });
